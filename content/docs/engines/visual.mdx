...
So in the desktop app this engine **refuses, and its refusal names the command line** rather than failing obscurely:

<CodeBlock
  file="the refusal"
  lang="text"
  code={`Visual regression needs to read directories *and* decode images.
Run it from the command line: twinscope baseline/ current/ --engine visual.`}
/>
